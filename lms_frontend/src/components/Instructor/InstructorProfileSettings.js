...
//D:\SE\django_lms\lms_frontend\src\components\Instructor\InstructorProfileSettings.js
function InstructorProfileSettings(){
    ...
    const submitForm =()=> {
        ...
        if (instructorData.p_image!==''){
            instructorFormData.append('profile_image', instructorData.p_image, instructorData.p_image.name);
        } 
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <form>
                                ...
                                <div className="mb-4">
                                    <label className="form-label" htmlFor="description">Profile Image</label>
