    ...
    return(
        <div className='container mt-4 col-md-12'>
            <div className = "row">
                ...
                <div className="card">
                <h5 className='card-header'>Published Assignments</h5>
                            <div className='card-body'>
                                <table className='table table-bordered'>
                                    ...
                                    <tr>
                                         ...
                                         <td>{row.deadline}</td>
                                         <td>
                                        <Link to={`/view-assignment/` + row.id} className='btn btn-success btn-sm active'>Edit Assignment</Link>
                                        <Link to={`/view-submission/` + row.id} className='btn btn-success btn-sm active'>View Assignment</Link>
                                         </td>
                                    </tr> 
                                    )}
                                    <tr></tr>
